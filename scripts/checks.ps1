...
$md=Get-ChildItem ./*.md -Recurse; foreach ($file in $md) { ((Get-Content $file.FullName) -replace 'https://cdn.jsdelivr.net/gh/tunisiano187/Chocolatey-packages@d15c4e19c709e7148588d4523ffc6dd3cd3c7e5e/icons/patreon.png', 'https://cdn.jsdelivr.net/gh/tunisiano187/choco-packages@f986b7f5de3afc021180256752805698d4efbc38/icons/patreon.png') -replace “tunisiano187/Chocolatey-packages”, “tunisiano187/Choco-packages” | Set-Content -Path $file.FullName }
